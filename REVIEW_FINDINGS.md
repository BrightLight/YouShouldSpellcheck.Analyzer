...
- [x] Updated AppVeyor and the analyzer project to apply its unique `1.2.{build}` version to both explicit SDK-style packing and AppVeyor's legacy automatic packaging path.
